...
const ManageBlogs = () => {
  ...
  const getBlogs = ({page, draft, deletedDocCount = 0 }) => {
    axios
    .post(import.meta.env.VITE_SERVER_DOMAIN + "/user-written-blogs", {
...
getBlogs({page:1, draft:true})
  ...
  return (
    ...
    <div className="relative mt-5 mb-10">
       ...
       <div className="relative bg-white w-full  left-0 flex items-center border-grey md:border-0 md:black md:inset-0 md:p-0 md:w-auto">
       <BsSearch className="pointer-events-none text-xl text-dark-grey ml-3 my-auto flex absolute" />
<input type="search"  className="w-full bg-grey p-4 pl-12 pr-6 rounded-full placeholder:text-dark-grey"
